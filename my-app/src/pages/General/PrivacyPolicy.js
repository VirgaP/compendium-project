  ...
  return (
    <MainContainer>
      <div className="page__container pt-2 general">
        ...
        <h3 className="bolder"> 1. Introduction</h3>
        <p className="rte py-1">
          Welcome to <b>Arttice</b>.
        </p>
        <p className="rte">
          <b>Arttice</b> (“us”, “we”, or “our”) operates arttice.com (hereinafter referred to as "<b>Service</b>").
        </p>
        <p className="rte">
          Our Privacy Policy governs your visit to <b>arttice.com</b>, and explains how we collect, safeguard and disclose information that results from your use of our Service.
        </p>
        <p className="rte">
        ...
        <h3 className="bolder"> 2. Definitions</h3>
        <p className="rte">
          <b>SERVICE</b> means the arttice.com website operated by Arttice.
        </p>
        <p className="rte">
        ...
        <h3 className="bolder">3. Information Collection and Use</h3>
        <p className="rte">
          We collect several different types of information for various purposes to provide and improve our Service to you.
        </p>
        <h3 className="bolder">4. Types of Data Collected</h3>
        <h3 className="bolder">Personal Data</h3>
        <p className="rte">
        ...
        <h3 className="bolder">Usage Data</h3>
        <p className="rte">
        ...
        <h3 className="bolder">Location Data</h3>
        <p className="rte">
          We may use and store information about your location if you give us permission to do so (“<b>Location Data</b>”). We use this data to provide features of our Service, to .<br/>
        <br/>You can enable or disable location services when you use our Service at any time by way of your device settings.
        </p>
        <h3 className="bolder">Tracking Cookies Data</h3>
        <p className="rte">
          ...
          <br/>You can instruct your browser to refuse all cookies or to indicate when a cookie is being sent. However, if you do not accept cookies, you may not be able to use some portions of our Service.<br/>
        ...
        <h3 className="bolder">Other Data</h3>
        <p className="rte">
        While using our Service, we may also collect the following information: sex, age, date of birth, place of birth, passport details, citizenship, registration at place of residence and actual address, telephone number (work, mobile), details of documents on education, qualification, professional training, employment agreements, <a href="https://policymaker.io/non-disclosure-agreement/" target="blank">NDA agreements</a>, information on bonuses and compensation, information on marital status, family members, social security (or other taxpayer identification) number, office location and other data.
        </p>
        <h3 className="bolder">5. Use of Data</h3>
        <p className="rte">
        Arttice uses the collected data for various purposes:<br/><br/>
        ...
        <h3 className="bolder">7. Transfer of Data</h3>
        <p className="rte">
        ...
        <h3 className="bolder">8. Disclosure of Data</h3>
        <p className="rte">
          ...
          0.3. <b>Other cases</b>. We may disclose your information also:<br/>
        ...
        <h3 className="bolder">9. Security of Data</h3>
        <p className="rte">
          The security of your data is important to us but remember that no method of transmission over the Internet or method of electronic storage is 100% secure. While we strive to use commercially acceptable means to protect your Personal Data, we cannot guarantee its absolute security.
        </p>
        <h3 className="bolder">10. Your Data Protection Rights Under General Data Protection Regulation (GDPR)</h3>
        <p className="rte">
        ...
        If you wish to be informed what Personal Data we hold about you and if you want it to be removed from our systems, please email us at <b>info@arttice.com</b>.<br/><br/>
        ...
        <h3 className="bolder">11. Your Data Protection Rights under the California Privacy Protection Act (CalOPPA)</h3>
        <p className="rte">
        CalOPPA is the first state law in the nation to require commercial websites and online services to post a privacy policy. The law’s reach stretches well beyond California to require a person or company in the United States (and conceivable the world) that operates websites collecting personally identifiable information from California consumers to post a conspicuous privacy policy on its website stating exactly the information being collected and those individuals with whom it is being shared, and to comply with this policy.
        <br/><br/>According to CalOPPA we agree to the following:<br/><br/>
        ...
        0.4. users are able to change their personal information by emailing us at info@arttice.com.<br/><br/>
        ...
        <h3 className="bolder">12. Your Data Protection Rights under the California Consumer Privacy Act (CCPA)</h3>
        <p className="rte">
        ...
        <b>0.1. What personal information we have about you. If you make this request, we will return to you:</b><br/><br/>
        ...
        <br/><br/>
        To exercise your California data protection rights described above, please send your request(s) by email: <b>info@arttice.com</b>.
        <br/><br/>
        Your data protection rights, described above, are covered by the CCPA, short for the California Consumer Privacy Act. To find out more, visit the official California Legislative Information website. The CCPA took effect on 01/01/2020.
        </p>
        <h3 className="bolder">13. Service Providers</h3>
        <p className="rte">
        We may employ third party companies and individuals to facilitate our Service (“Service Providers”), provide Service on our behalf, perform Service-related services or assist us in analysing how our Service is used.
        <br/><br/>
        These third parties have access to your Personal Data only to perform these tasks on our behalf and are obligated not to disclose or use it for any other purpose.
        </p>
        <h3 className="bolder">14. Analytics</h3>
        <p className="rte">
          We may use third-party Service Providers to monitor and analyze the use of our Service.
        </p>
        <h3 className="bolder">15. CI/CD tools</h3>
        <p className="rte">
          We may use third-party Service Providers to automate the development process of our Service.
        </p>
        <h3 className="bolder">16. Advertising</h3>
        <p className="rte">
          We may use third-party Service Providers to show advertisements to you to help support and maintain our Service.
        </p>
        <h3 className="bolder">17. Behavioral Remarketing</h3>
        <p className="rte">
          We may use remarketing services to advertise on third party websites to you after you visited our Service. We and our third-party vendors use cookies to inform, optimise and serve ads based on your past visits to our Service.
        </p>
        <h3 className="bolder">18. Links to Other Sites</h3>
        <p className="rte">
        Our Service may contain links to other sites that are not operated by us. If you click a third party link, you will be directed to that third party’s site. We strongly advise you to review the Privacy Policy of every site you visit.
        <br/><br/>
        We have no control over and assume no responsibility for the content, privacy policies or practices of any third party sites or services.
        </p>
        <h3 className="bolder">19. Children’s Privacy</h3>
        <p className="rte">
        ...
        <h3 className="bolder">20. Changes to This Privacy Policy</h3>
        <p className="rte">
        ...
        <h3 className="bolder">21. Contact Us</h3>
        <p className="rte">
        If you have any questions about this Privacy Policy, please contact us by email: <b>info@arttice.com</b>.
        </p>
        <h4 className="py-2">© IdeasBlockLT 2020</h4>
